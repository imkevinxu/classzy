...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Assignment.avg_time'
        db.alter_column('classes_assignment', 'avg_time', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3))

        # Changing field 'Assignment.std_time'
        db.alter_column('classes_assignment', 'std_time', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3))


    def backwards(self, orm):
        
        # Changing field 'Assignment.avg_time'
        db.alter_column('classes_assignment', 'avg_time', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Assignment.std_time'
        db.alter_column('classes_assignment', 'std_time', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        'classes.assignment': {
            ...
            'avg_time': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '5', 'decimal_places': '3'}),
            ...
            'std_time': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '5', 'decimal_places': '3'}),
