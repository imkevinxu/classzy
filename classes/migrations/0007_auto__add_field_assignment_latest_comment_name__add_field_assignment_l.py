...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.latest_comment_name'
        db.add_column('classes_assignment', 'latest_comment_name', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'Assignment.latest_comment_text'
        db.add_column('classes_assignment', 'latest_comment_text', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.latest_comment_name'
        db.delete_column('classes_assignment', 'latest_comment_name')

        # Deleting field 'Assignment.latest_comment_text'
        db.delete_column('classes_assignment', 'latest_comment_text')
