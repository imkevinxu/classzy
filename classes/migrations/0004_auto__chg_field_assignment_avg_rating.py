...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Assignment.avg_rating'
        db.alter_column('classes_assignment', 'avg_rating', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Assignment.avg_rating'
        db.alter_column('classes_assignment', 'avg_rating', self.gf('django.db.models.fields.FloatField')())
