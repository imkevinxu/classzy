...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.avg_rating'
        db.add_column('classes_assignment', 'avg_rating', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.avg_rating'
        db.delete_column('classes_assignment', 'avg_rating')
