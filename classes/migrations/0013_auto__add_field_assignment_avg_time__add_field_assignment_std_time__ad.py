...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.avg_time'
        db.add_column('classes_assignment', 'avg_time', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Assignment.std_time'
        db.add_column('classes_assignment', 'std_time', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Assignment.min_time'
        db.add_column('classes_assignment', 'min_time', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Assignment.max_time'
        db.add_column('classes_assignment', 'max_time', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.avg_time'
        db.delete_column('classes_assignment', 'avg_time')

        # Deleting field 'Assignment.std_time'
        db.delete_column('classes_assignment', 'std_time')

        # Deleting field 'Assignment.min_time'
        db.delete_column('classes_assignment', 'min_time')

        # Deleting field 'Assignment.max_time'
        db.delete_column('classes_assignment', 'max_time')
    ...
    models = {
        'classes.assignment': {
            ...
            'avg_time': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            ...
            'max_time': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'min_time': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'std_time': ('django.db.models.fields.FloatField', [], {'default': '0'}),
