...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.chart_url'
        db.add_column('classes_assignment', 'chart_url', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.chart_url'
        db.delete_column('classes_assignment', 'chart_url')
