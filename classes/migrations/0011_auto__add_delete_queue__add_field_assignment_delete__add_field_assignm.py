...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Delete_Queue'
        db.create_table('classes_delete_queue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('classes', ['Delete_Queue'])

        # Adding field 'Assignment.delete'
        db.add_column('classes_assignment', 'delete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Assignment.delete_queue'
        db.add_column('classes_assignment', 'delete_queue', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='Assignment_Delete', unique=True, null=True, to=orm['classes.Delete_Queue']), keep_default=False)

        # Adding field 'Class.delete_queue'
        db.add_column('classes_class', 'delete_queue', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='Class_Delete', unique=True, null=True, to=orm['classes.Delete_Queue']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Delete_Queue'
        db.delete_table('classes_delete_queue')

        # Deleting field 'Assignment.delete'
        db.delete_column('classes_assignment', 'delete')

        # Deleting field 'Assignment.delete_queue'
        db.delete_column('classes_assignment', 'delete_queue_id')

        # Deleting field 'Class.delete_queue'
        db.delete_column('classes_class', 'delete_queue_id')
